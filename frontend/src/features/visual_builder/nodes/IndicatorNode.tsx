...
export function IndicatorNode({ id, data, selected }: NodeProps<IndicatorNode>) {
  ...
  return (
    <div
      ...
      className={`rf-node rf-node--indicator bg-[#1c2130] border rounded-xl shadow-lg text-slate-100 p-4 min-w-[240px] cursor-pointer transition-all ${
        isSelected ? 'border-purple-400 ring-2 ring-purple-400/50 shadow-purple-500/20' : 'border-purple-500/30 hover:border-purple-500/50'
      }`}
    >
