...
export function SignalNode({ id, data, selected }: NodeProps<SignalNode>) {
  ...
  return (
    <div
      ...
      className={`rf-node rf-node--signal bg-[#1c2130] border rounded-xl shadow-lg text-slate-100 p-4 min-w-[240px] cursor-pointer transition-all ${
        isSelected ? 'border-amber-400 ring-2 ring-amber-400/50 shadow-amber-500/20' : 'border-amber-500/30 hover:border-amber-500/50'
      }`}
    >
